							...
							<tr>
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="520" id="template_header" style="<?php echo $template_header; ?>" bgcolor="#ffffff">
										...
										<tr>
											<td><div id="template_header_image"><p style="margin-top:0;"><img src="<?= esc_url( $header_img ) ?>" alt="<?= get_bloginfo('name') ?>" width="600" height="100"></p></div></td>
										</tr>
										<?php endif; ?>
										<tr>
											<td>
												<h1 style="color: #000; margin: 0; padding: 0 24px; font-size: 32px; display: block; font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-weight: 500; line-height: 1.2;"><?php echo $heading; ?></h1>
											</td>
										</tr>
									</table>
									<!-- End Header -->
